const PE_DATA = {
  ...
  employeeGuides: {
    ...
    "guide-photo-books": {
      ...
      steps: [
        { number: "1", title: "Gather the required pieces", text: "You need the white printed cover, black photobook, printed layflat pages, and clamp slide. Keep the order together before peeling any liners.", image: "assets/main-photo/assembly/steps/photobook-step-1-materials.jpg", alt: "Cropped photobook reference showing the white cover, black photobook, printed layflat pages, and clamp slide." },
        { number: "2", title: "Print and inspect the cover", text: "Print the white cover and check that it is straight, clean, and facing the correct direction before attaching it to the book.", image: "assets/main-photo/assembly/steps/photobook-step-2-print-cover.jpg", alt: "Cropped photobook reference showing the white printed cover being loaded and checked." },
        { number: "3", title: "Place the cover face down", text: "Lay the printed cover face down on a clean flat surface. Remove only the small thin white liners shown in the reference step.", image: "assets/main-photo/assembly/steps/photobook-step-3-lay-cover.jpg", alt: "Cropped photobook reference showing the printed cover face down and thin liners removed." },
        { number: "4", title: "Stand the black photobook upright", text: "Place the black photobook upright on the printed cover and align the spine before wrapping.", image: "assets/main-photo/assembly/steps/photobook-step-4-stand-book.jpg", alt: "Cropped photobook reference showing the black photobook standing upright on the cover." },
        { number: "5", title: "Wrap and press the cover", text: "Wrap the printed cover around the black photobook, fold in the flaps, and press along the front edge and spine so the cover sticks cleanly.", image: "assets/main-photo/assembly/steps/photobook-step-5-wrap-cover.jpg", alt: "Cropped photobook reference showing the printed cover wrapped and pressed around the book." },
        { number: "6", title: "Attach the back and inside flaps", text: "Flip the book as shown on the reference sheet, peel the remaining liners, and adhere the back cover and inside flap without wrinkles.", image: "assets/main-photo/assembly/steps/photobook-step-6-attach-flaps.jpg", alt: "Cropped photobook reference showing the back cover and inside flap adhesion steps." },
        { number: "7", title: "Insert pages and clamp the spine", text: "Slide the printed pages onto the clamp slide with the photos close to the edge nearest the clamp, then fold the photobook inside out and slide the clamp through both guides to finish.", image: "assets/main-photo/assembly/steps/photobook-step-7-clamp-pages.jpg", alt: "Cropped photobook reference showing the printed pages inserted and clamp slide installed." }
      ]
    },
    "guide-calendars": {
    ...
    "guide-magnets": {
      ...
      steps: [
        { number: "1", title: "Remove the acrylic pieces", text: "Take the acrylic front and acrylic back out of the sleeve. Keep the sleeve because the finished magnet goes back into it.", image: "assets/main-photo/assembly/steps/magnet-step-1-remove-pieces.jpg", alt: "Cropped acrylic magnet reference showing step 1, remove the front and back acrylic parts from the sleeve." },
        { number: "2", title: "Trim the photo", text: "Trim the photo to 2x2 using the passport cutter. Check the crop before placing it into the acrylic.", image: "assets/main-photo/assembly/steps/magnet-step-2-trim-photo.jpg", alt: "Cropped acrylic magnet reference showing step 2, trim the photo to 2 by 2." },
        { number: "3", title: "Set the back down first", text: "Place the acrylic back part down with the magnets facing up.", image: "assets/main-photo/assembly/steps/magnet-step-3-back-down.jpg", alt: "Cropped acrylic magnet reference showing step 3, place the acrylic back with magnets facing up." },
        { number: "4", title: "Place the photo face up", text: "Set the trimmed photo face up on the acrylic back. Keep the photo straight and centered.", image: "assets/main-photo/assembly/steps/magnet-step-4-photo-face-up.jpg", alt: "Cropped acrylic magnet reference showing step 4, place the photo face up on the acrylic back." },
        { number: "5", title: "Click the front into place", text: "Place the acrylic front part onto the photo. The magnets should pull the back and front acrylic pieces together.", image: "assets/main-photo/assembly/steps/magnet-step-5-front-click.jpg", alt: "Cropped acrylic magnet reference showing step 5, place the acrylic front onto the photo." },
        { number: "6", title: "Sleeve the finished magnet", text: "Make sure the photo is straight, clean, and fully inside the acrylic edges, then place the assembled magnet back into the sleeve.", image: "assets/main-photo/assembly/steps/magnet-step-6-sleeve.jpg", alt: "Cropped acrylic magnet reference showing step 6, return the assembled magnet to the sleeve." }
      ]
    },
    "guide-specialty": {
      ...
      steps: [
        { number: "1", title: "Check what is in the box", text: "Confirm you have the chipboard, frame assembly, and spacer tool before starting the wall tile.", image: "assets/main-photo/assembly/steps/wall-tile-step-1-check-box.jpg", alt: "Cropped wall tile reference showing the chipboard, frame assembly, and spacer tool." },
        { number: "2", title: "Identify the frame parts", text: "Check the frame top, frame back, and spiral disk pad before separating the frame assembly.", image: "assets/main-photo/assembly/steps/wall-tile-step-2-frame-parts.jpg", alt: "Cropped wall tile reference showing the frame assembly parts." },
        { number: "3", title: "Separate the frame assembly", text: "Place the frame back on the table facing up. Flex the frame front away from the backer to separate the pieces.", image: "assets/main-photo/assembly/steps/wall-tile-step-3-separate-frame.jpg", alt: "Cropped wall tile reference showing how to flex and separate the frame assembly." },
        { number: "4", title: "Place the photo on chipboard", text: "Set the photo onto the chipboard and make sure the image is straight before placing it into the frame.", image: "assets/main-photo/assembly/steps/wall-tile-step-4-photo-chipboard.jpg", alt: "Cropped wall tile reference showing the photo placed onto the chipboard." },
        { number: "5", title: "Load the frame back", text: "Make sure the frame back is facing upward, then place the chipboard and photo into the frame back and add the frame front.", image: "assets/main-photo/assembly/steps/wall-tile-step-5-load-frame.jpg", alt: "Cropped wall tile reference showing the chipboard, photo, and frame front placement." },
        { number: "6", title: "Snap all four corners", text: "Press down on all four corners until the frame snaps together. Check that the photo is clean and centered.", image: "assets/main-photo/assembly/steps/wall-tile-step-6-snap-corners.jpg", alt: "Cropped wall tile reference showing the corners being pressed to snap the frame together." },
        { number: "7", title: "Package with spacer tool", text: "Place the assembled wall tile and one spacer tool into the packaging box. Make sure the spiral disk is locked in place before packaging.", image: "assets/main-photo/assembly/steps/wall-tile-step-7-package.jpg", alt: "Cropped wall tile reference showing packaging with the spacer tool and spiral disk check." }
      ]
    },
